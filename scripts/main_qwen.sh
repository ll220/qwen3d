...
# babel paths
export DETECTRON2_DATASETS_2D="/data/group_data/katefgroup-ssd/datasets/lucy/datasets_2d"
...
export LOCATE3D_DATASET="/data/group_data/katefgroup-ssd/datasets/lucy/locate_3d"
export COCO_REF_DATASET="/data/group_data/katefgroup-ssd/datasets/lucy/datasets_2d"
export CLIP_SAMPLING_PATH="/data/user_data/ayushj2/refer_it_3d"
export RETURN_SCENE_BATCH_SIZE=1 # use single batch
export PRECOMPUTED_SCANNET_PATH="/data/user_data/ayushj2/refer_it_3d/"
export LLAVA_INSTRUCT_PATH="/data/group_data/katefgroup-ssd/datasets/llava_instruct/llava_instruct_150k.json"
FEATURE_DIR="/data/user_data/lucylin/scannet_image_qwen_features"
SCANNET_DATA_DIR="/data/group_data/katefgroup-ssd/datasets/lucy/mask3d_processed/scannet/train_validation_database.yaml"
SCANNET200_DATA_DIR="/data/group_data/katefgroup-ssd/datasets/lucy/mask3d_processed/scannet200/train_validation_database.yaml"
SCANNETPP_DATA_DIR="/data/group_data/katefgroup-ssd/datasets/lucy/mask3d_processed/scannetpp/validation_database.yaml"
MATTERPORT_DATA_DIR="/data/group_data/katefgroup-ssd/datasets/lucy/mask3d_processed/matterport/train_validation_database.yaml"
S3DIS_DATA_DIR="/data/user_data/lucylin/SEMSEG_100k/s3dis/train_validation_database.yaml"
OUTPUT_DIR_PREFIX="/data/group_data/katefgroup/language_grounding/rodin_outputs/train"
CHECKPOINT_PATH='./ckpts'
CKPTS_PATH='./ckpts'


# orchard flame paths
# export DETECTRON2_DATASETS_2D="/project/flame/yifanliu/language_grounding/datasets_2d"
# export DETECTRON2_DATASETS="/project/flame/yifanliu/language_grounding/SEMSEG_100k"
# export REF_DATASET="/project/flame/yifanliu/language_grounding/refer_it_3d/"
# export COCO_REF_DATASET="/project/flame/yifanliu/language_grounding/datasets_2d"
# export CLIP_SAMPLING_PATH="/project/flame/yifanliu/language_grounding/refer_it_3d"
# export RETURN_SCENE_BATCH_SIZE=1 # use single batch
# export PRECOMPUTED_SCANNET_PATH="/project/flame/yifanliu/language_grounding/refer_it_3d/"
# SCANNET_DATA_DIR="/project/flame/yifanliu/language_grounding/mask3d_processed/scannet/train_validation_database.yaml"
# SCANNET200_DATA_DIR="/project/flame/yifanliu/language_grounding/mask3d_processed/scannet200/train_validation_database.yaml"
# MATTERPORT_DATA_DIR="/project/flame/yifanliu/language_grounding/mask3d_processed/matterport/train_validation_database.yaml"
# S3DIS_DATA_DIR="/project/flame/yifanliu/language_grounding/SEMSEG_100k/s3dis/train_validation_database.yaml"
# OUTPUT_DIR_PREFIX="/project/flame/yifanliu/language_grounding/rodin_exps"
# CHECKPOINT_PATH='./ckpts'
# CKPTS_PATH='./ckpts'
# CHECKPOINT_PATH='/data/matrix/projects/katefgroup/brick/language_grounding/bdetr2_imp_ckpts'
# CKPTS_PATH='/data/matrix/projects/katefgroup/brick/language_grounding/bdetr2_imp_ckpts'
...
# OUTPUT_DIR_PREFIX="/data/user_data/lucylin/rodin_outputs"
...
$CMD $PYTHON_FILE --dist-url="tcp://127.0.0.1:$(shuf -i 19801-22947 -n 1)" --num-gpus $NUM_GPUS --num-machines $NUM_MACHINES --config-file $CONFIG_FILE $EVAL_ARG $RESUME_ARG $SLURM_ARG \
...
MATCHING_CLASS_WEIGHT None \
MATCHING_MASK_WEIGHT None \
MATCHING_DICE_WEIGHT None \
...
USE_BOX_LOSS False \
MODEL.MASK_FORMER.BOX_WEIGHT 0.0 \
MODEL.MASK_FORMER.GIOU_WEIGHT 0.0 \
MATCHING_BOX_WEIGHT 0.1 \
MATCHING_GIOU_WEIGHT 0.1 \
BREAKPOINT_ON_ERROR $BREAKPOINT_ON_ERROR \
SOLVER.LR_SCHEDULER_NAME "warmupconstantlr" SOLVER.WARMUP_ITERS 2000 FORCE_DECODER_3D False \
MULTIVIEW_XYZ_SCALES '[28, 7]' FORCE_VIT_XYZ_SCALE True \
INPUT.VOXEL_SIZE '[0.05,0.05]' \
INPUT.IMAGE_SIZE 448 INPUT.MIN_SIZE_TEST 448 INPUT.MAX_SIZE_TEST 448 \
INPUT.SIZE_DIVISIBILITY 1 MODEL.MASK_FORMER.SIZE_DIVISIBILITY 1 \
...
DINO_EVAL_BATCH True \
DINO_EVAL_BATCH_SIZE 4 \
TEST.EVAL_3D True  \
USE_AUTO_NOUN_DETECTION True DINO_EVAL_BATCH True \
DINO_EVAL_BATCH_SIZE 4 \
GENERATION False \
GRADIENT_CHECKPOINTING False ROPE_TYPE "custom_txyz" \
CAUSAL_MASK False \
USE_LORA True \
SOLVER.LR_SCHEDULER_NAME "warmupconstantlr" \
SOLVER.AMP.DTYPE "bfloat16" $@
if [[ $? == 124 ]]; then 
