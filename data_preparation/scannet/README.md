...
Make sure to change `SCANNET_DATA_DIR` in `qwen3d/config.py` to the `SAVE_DATA/train_validation_database.yaml'

Similarly, change  `SCANNET200_DATA_DIR` in `qwen3d/config.py` to the `SAVE_DATA/train_validation_database.yaml'
