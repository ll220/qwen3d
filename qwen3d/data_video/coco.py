...
class COCO:
    ...
    def getAnnIds(self, imgIds=[], catIds=[], areaRng=[], iscrowd=None):
        ...
        catIds = catIds if type(catIds) is list else [catIds]
    ...
    def getCatIds(self, catNms=[], supNms=[], catIds=[]):
        ...
        """
        catNms = catNms if type(catNms) is list else [catNms]
        supNms = supNms if type(supNms) is list else [supNms]
        catIds = catIds if type(catIds) is list else [catIds]
            ...
            for ann in anns:
                ...
                if "segmentation" in ann:
                    if type(ann["segmentation"]) is list:
                        ...
                        if type(ann["segmentation"]["counts"]) is list:
                ...
                if "keypoints" in ann and type(ann["keypoints"]) is list:
    ...
    def annToRLE(self, ann):
        ...
        if type(segm) is list or ('counts' in segm and type(segm["counts"]) is list):
            t = self.imgs[ann["image_id"]]
        ...
        elif 'counts' in segm and type(segm["counts"]) is list:
            # uncompressed RLE
