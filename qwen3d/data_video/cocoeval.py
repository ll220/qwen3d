...
class COCOeval:
    ...
    def evaluateImg(self, imgId, catId, aRng, maxDet):
        ...
        iscrowd = [int(o["iscrowd"]) if 'is_crowd' in o else 0 for o in gt]
        # load computed ious
        ious = (
...
def summarize(params, eval):
    ...
    def _summarizeDets():
        ...
        stats[1] = _summarize(1, iouThr=0.5, maxDets=params.maxDets[2])
        stats[2] = _summarize(1, iouThr=0.75, maxDets=params.maxDets[2])
