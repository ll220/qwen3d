...
from .load_locate3d import register_ref_locate3d
...
if __name__.endswith(".builtin"):
    ...
    # scannetpp register
    # scannetpp_root = os.getenv("SCANNET_PP_DATASET", "datasets/scannetpp")
    register_all_dataset_single(_root, dataset_name="scannetpp")

    # matterport register
    register_all_dataset_single(_root, dataset_name="matterport")

    # Scannet based Referential grounding 3D Datasets
    _root_sr3d = os.getenv(
        "REF_DATASET", "/path/to/language_grounding/refer_it_3d/"
    )
    register_ref(_root_sr3d)
    
    # locate 3d based referential grounding 3D Datasets
    _root_locate3d = os.getenv(
        "LOCATE3D_DATASET", "/path/to/language_grounding/locate_it_3d/"
    )
    register_ref_locate3d(_root_locate3d)
